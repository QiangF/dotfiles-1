...
" 启动的时不显示提示 I --> don't give the intro message when starting Vim :intro
" XXX 要放在 nocompatible 后面不然会被还原
set shortmess=atI
...
"" # vim-cn / sw 兄
"" head
noremap <c-u>h "ayy:let @a=repeat('=',strwidth(@a)-1)."\n"<cr>Pjp
"" line
noremap <c-u>l "ayy:let @a=repeat('-',strwidth(@a)-1)."\n"<cr>p
